      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
				  ...
				  <center> <h3> <b><u> KATEGORI ASSET </b></u> </h3> </center>
				  <br>
						...
						<form method="POST" action="fungsi/tambah/tambah.php?kategori=tambah">
							<table>
								<tr>
									<td style="width:15pc;"><input type="text" class="form-control" name="kategori" placeholder="Tambah Type Barang"></td>
									<td><button id="tombol-simpan" class="btn btn-primary"><i class="fa fa-plus"></i> Add </button></td>
								</tr>
							</table>
						</form>
						<br/>
