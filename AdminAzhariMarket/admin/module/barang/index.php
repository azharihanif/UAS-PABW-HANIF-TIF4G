          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						<center> <h3> <b><u> ASSET BARANG </b></u> </h3> </center>
						<br>
						<?php if(isset($_GET['success-stok'])){?>
						<div class="alert alert-success">
							<p>Tambah Stok Sukses !</p>
						</div>
						<?php }?>
						...
						<table>
							<tr>
								<td><button id="tombol-simpan" onclick="clickModals()" class="btn btn-primary"><i class="fa fa-plus"></i> Add More Product  </button></td>
							</tr>
						</table>
						<br/>
						<!-- view barang -->	
