                      	...
                      	<div class="col-md-3">
                      		<div class="panel panel-primary">
                      			<div class="panel-heading">
						  			<center><h5><b>ID BARANG</b></h5></center>
                      			</div>
                      			<div class="panel-body">
									<center><h1><?php echo $hasil_barang;?></h1></center>
								</div>
								<div class="panel-footer">
									<center><button><h4 style="font-size:15px;"><a href='index.php?page=barang'>DETAILS <i class='fa fa-arrow-right'></i></a></h4></button></center>
								</div>
	                      	</div><!--/grey-panel -->
                      	</div><!-- /col-md-3-->
                      <!-- STATUS PANELS -->
                      	<div class="col-md-3">
                      		<div class="panel panel-success">
                      			<div class="panel-heading">
								  <center><h5><b>STOK BARANG</b></h5></center>
                      			</div>
                      			<div class="panel-body">
                      ...
                      <!-- STATUS PANELS -->
                      	<div class="col-md-3">
                      		<div class="panel panel-info">
                      			<div class="panel-heading">
								  <center><h5><b>BARANG TERJUAL</b></h5></center>
                      			</div>
                      			<div class="panel-body">
									<center><h1><?php echo $jual['stok'];?></h1></center>
								</div>
								<div class="panel-footer">
								<center><button><h4 style="font-size:15px;"><a href='index.php?page=laporan'>DETAILS <i class='fa fa-arrow-right'></i></a></h4></button></center>
								</div>
	                      	</div><!--/grey-panel -->
                      	</div><!-- /col-md-3-->
                      	<div class="col-md-3">
                      		<div class="panel panel-danger">
                      			<div class="panel-heading">
						  			<center><h5><b>TYPE BARANG</b></h5></center>
                      			</div>
                      			<div class="panel-body">
									<center><h1><?php echo $hasil_kategori;?></h1></center>
								</div>
								<div class="panel-footer">
								<center><button><h4 style="font-size:15px;"><a href='index.php?page=kategori'>DETAILS <i class='fa fa-arrow-right'></i></a></h4></button></center>
							</div>
	                      	</div><!--/grey-panel -->
							  <br> <br>
                      	</div><!-- /col-md-3-->
						...
						<?php  $c = $lihat -> jml(); ?>
						<h4> <b>BUDGET : Rp.<?php echo number_format($c['byr']);?>,- </b></h4>
