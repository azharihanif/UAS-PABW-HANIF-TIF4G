...
<html lang="en">
  <head>
    ...
    <title>Admin AzhariMarket </title>
    ...
    <style>
		.header{background:#2E4053; color:#fff;}
      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" onclick="javascript: return confirm('Ingin Logout ?');" href="logout.php" style="color:black"><b>LOGOUT</b></a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
